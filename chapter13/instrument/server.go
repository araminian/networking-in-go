...
here is you’re defining the server’s ConnState field, accepting it as an argument
to the newHTTPServer function.
*/
...
connStateMetrics function to the newHTTPServer function anytime you want
to initialize a new HTTP server and track its open connections. If the server
establishes a new connection, you increment the open connections gauge
by 1. If a connection closes, you decrement the gauge by 1. Go kit’s gauge
